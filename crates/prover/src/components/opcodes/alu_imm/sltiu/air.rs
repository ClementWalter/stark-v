//! AIR component for SLTIU opcode (dummy constraints).

use stwo_constraint_framework::{EvalAtRow, FrameworkComponent, FrameworkEval};

use crate::components::opcodes::alu_imm::sltiu::columns::SltiuColumns;
...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        let cols = SltiuColumns::from_eval(&mut eval);
