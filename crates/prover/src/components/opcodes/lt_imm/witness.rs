...
pub fn gen_interaction_trace(
    ...
    // 9. memory_access: -enabler * (0, rd_addr, rd_clock_prev, rd_prev_0..3)
    ...
    // 10. memory_access: +enabler * (0, rd_addr, clock, cmp_result, 0, 0, 0)
    ...
    // 11. range_check_20: -1 * (clock - rd_clock_prev)
