...
pub fn gen_interaction_trace(
    ...
    // 12. memory_access: -enabler * (0, rd_addr, rd_clock_prev, rd_prev_0..3)
    ...
    // 13. memory_access: +enabler * (0, rd_addr, clock, cmp_result, 0, 0, 0)
    ...
    // 14. range_check_20: -1 * (clock - rd_clock_prev)
