...
pub fn gen_interaction_trace(
    ...
    // 13. memory_access: -enabler * (0, rd_addr, rd_clock_prev, rd_prev_0..3)
    ...
    // 14. memory_access: +enabler * (0, rd_addr, clock, rd_next_0..3)
    ...
    // 15. range_check_20: -1 * (clock - rd_clock_prev)
