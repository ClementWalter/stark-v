...
// Initialized (.data) and uninitialized (.bss) globals to exercise both segments.
#[no_mangle]
static INIT_MAGIC: u32 = 0xDEAD_BEEF;

#[no_mangle]
static mut SCRATCH_PAD: [u8; 8] = [0; 8];
...
fn main() -> ! {
    let _value = compute() ^ INIT_MAGIC;
    unsafe {
        SCRATCH_PAD[0] = (_value & 0xFF) as u8;
    }
    loop {}
}
