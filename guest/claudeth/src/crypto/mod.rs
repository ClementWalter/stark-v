...
pub use secp256k1::{
    Secp256k1Error, address_from_public_key, address_from_secret_key, public_key_from_secret,
    recover_address, recover_public_key, sign_recoverable, verify_signature,
};
