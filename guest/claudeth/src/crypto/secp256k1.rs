...
use crate::crypto::secp256k1_math::{
    SECP256K1_B, mod_add, mod_inv, mod_mul, mod_pow, mod_sub, secp256k1_n, secp256k1_p,
};
use crate::crypto::secp256k1_point::{AffinePoint, point_add, scalar_mul};
...
pub fn sign_recoverable(
    ...
    for attempt in 0u64..1024 {
        ...
        let mut recid = if (y & U256::ONE) == U256::ONE {
            1u8
        } else {
            0u8
        };
...
mod tests {
    ...
    fn test_verify_signature_valid() {
        let message_hash = Hash::from([
            0xce, 0xb8, 0x71, 0xdb, 0x69, 0x75, 0x4f, 0x58, 0x33, 0x38, 0x15, 0x58, 0x28, 0xaa,
            0x4e, 0xd5, 0xd9, 0xc8, 0x99, 0x18, 0xbd, 0x92, 0x27, 0x27, 0x5b, 0x0a, 0x71, 0x51,
            0x54, 0x69, 0x25, 0x4a,
        ]);
        let signature = [
            0x0f, 0x43, 0x8d, 0x04, 0xf4, 0x6a, 0x2b, 0x53, 0x71, 0x96, 0xed, 0xa2, 0x48, 0x6c,
            0x40, 0xcb, 0x0f, 0xc1, 0xfb, 0x6d, 0x84, 0xa2, 0x58, 0xd6, 0x75, 0x34, 0xe5, 0x18,
            0x71, 0xc4, 0xf5, 0x3a, 0x5a, 0xb0, 0x4d, 0xbc, 0x9c, 0x36, 0x56, 0x2f, 0xf4, 0x38,
            0x14, 0xc6, 0xd9, 0xf8, 0xbf, 0x9b, 0xdc, 0x6b, 0x21, 0x0f, 0x52, 0x8b, 0x9b, 0xd1,
    ...
    fn test_recover_public_key_vector() {
        let message_hash = Hash::from([
            0xe5, 0x9a, 0xfd, 0xcd, 0xda, 0x4c, 0xc4, 0xd8, 0xa5, 0x2e, 0x64, 0xec, 0xb2, 0x82,
            0xb1, 0xfc, 0xce, 0x9a, 0x55, 0xcd, 0x14, 0xfd, 0x33, 0xe4, 0x89, 0x21, 0xdc, 0x9e,
            0xba, 0xd6, 0xeb, 0x0b,
        ]);
        let signature = [
            0xf4, 0x1a, 0x0c, 0x71, 0xd4, 0xd3, 0x2c, 0xd7, 0x00, 0xb1, 0xed, 0x30, 0x60, 0xdb,
            0xde, 0xc6, 0xd0, 0xfe, 0x76, 0x6a, 0x19, 0x3d, 0x39, 0x32, 0xa3, 0x97, 0x5b, 0x37,
            0xc4, 0x80, 0x85, 0xf1, 0x6a, 0xab, 0x53, 0xe4, 0x63, 0x5a, 0x05, 0xba, 0x30, 0xe1,
            0x61, 0x80, 0x87, 0x95, 0x2d, 0x88, 0xf3, 0xb3, 0x85, 0x49, 0xd0, 0xdf, 0xb7, 0x8d,
    ...
    fn test_recover_address_vector() {
        ...
        let recovered = recover_address(&message_hash, &signature, 1).expect("recover address");
    ...
    fn test_verify_wrong_public_key() {
        ...
        let wrong_public_key = [
            ...
            0x5c, 0x70, 0x9e, 0xe5, 0x1a, 0xe1, 0x68, 0xfe, 0xa6, 0x3d, 0xc3, 0x39, 0xa3, 0xc5,
            0x84, 0x19, 0x46, 0x6c, 0xea, 0xee, 0xf7, 0xf6, 0x32, 0x65, 0x32, 0x66, 0xd0, 0xe1,
    ...
    fn test_verify_wrong_message() {
        let wrong_message_hash = Hash::from([
            0x77, 0x01, 0x5a, 0x87, 0x9d, 0x44, 0xb7, 0xfb, 0x32, 0x3a, 0x89, 0x02, 0x5f, 0x6a,
            0x8f, 0x9c, 0x27, 0x49, 0x73, 0x15, 0x5c, 0x49, 0x2f, 0xa7, 0x82, 0x0c, 0xa6, 0x54,
            0xfb, 0xc3, 0x14, 0x89,
        ]);
        let signature = [
            0x0f, 0x43, 0x8d, 0x04, 0xf4, 0x6a, 0x2b, 0x53, 0x71, 0x96, 0xed, 0xa2, 0x48, 0x6c,
