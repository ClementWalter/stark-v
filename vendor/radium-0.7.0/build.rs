...
fn main() -> Result<(), Box<dyn Error>> {
    println!("cargo::rustc-check-cfg=cfg(radium_atomic_8)");
    println!("cargo::rustc-check-cfg=cfg(radium_atomic_16)");
    println!("cargo::rustc-check-cfg=cfg(radium_atomic_32)");
    println!("cargo::rustc-check-cfg=cfg(radium_atomic_64)");
    println!("cargo::rustc-check-cfg=cfg(radium_atomic_ptr)");
